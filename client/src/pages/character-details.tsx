...
const CharacterDetailsPage: React.FC = () => {
  ...
  const createCharacterMutation = useMutation({
    ...
    onSuccess: (newCharacter) => {
      ...
      // Refresh character list and redirect to character view
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card>
                  <CardContent className="p-6">
                    ...
                    <ul className="list-disc list-inside text-neutral-600">
                      {character?.skills?.split(',').map((skill, index) => (
                ...
                <Card>
                  <CardContent className="p-6">
                    ...
                    <ul className="list-disc list-inside text-neutral-600">
                      {character?.goals?.split(',').map((goal, index) => (
                ...
                <Card>
                  <CardContent className="p-6">
                    ...
                    <ul className="list-disc list-inside text-neutral-600">
                      {character?.fears?.split(',').map((fear, index) => (
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <ul className="list-disc list-inside text-neutral-600">
                    {character?.relationships?.split(',').map((relationship, index) => (
              ...
              {character?.secrets && (
                <Card>
                  <CardContent className="p-6">
                    ...
                    <p className="text-neutral-600">{character.secrets}</p>
                  </CardContent>
                </Card>
              )}
              ...
              {character?.quirks && (
                <Card>
                  <CardContent className="p-6">
                    ...
                    <ul className="list-disc list-inside text-neutral-600">
                      {character?.quirks?.split(',').map((quirk, index) => (
              ...
              {character?.motivations && (
                <Card>
                  <CardContent className="p-6">
                    ...
                    <ul className="list-disc list-inside text-neutral-600">
                      {character?.motivations?.split(',').map((motivation, index) => (
              ...
              {character?.flaws && (
                <Card>
                  <CardContent className="p-6">
                    ...
                    <ul className="list-disc list-inside text-neutral-600">
                      {character?.flaws?.split(',').map((flaw, index) => (
